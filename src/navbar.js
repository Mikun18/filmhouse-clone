    ...
    <SearchContext.Provider value={{ setshowSearch, setShowSignIn }}>
      ...
      <div className={navbar ? "nav active" : "nav"} id="navbar">
        <div className="container">
          <Link to="/">
            <img
              src="./filmhouse-clone/logo.png"
              alt="film-house logo"
              style={{ width: "120px" }}
            />
          </Link>
          <div>
            <Link to="/" className="nav-item" style={{ marginLeft: "100px" }}>
              Get Tickets
            </Link>
    ...
    <section>
      <div className="smaller-navbar">
        ...
        <FontAwesomeIcon
          ...
          onClick={() => setshowSearch(true)}
          className="smallernav-search"
        />
        <FontAwesomeIcon
          icon={faUser}
          className="smallernav-user"
          style={{ cursor: "pointer" }}
          onClick={() => setShowSignIn(true)}
        />
  ...
  return (
    <article className="sidebar-bg">
      ...
      >
        ...
        />
        <Link to="/" className="side-item" variants={listVariant}>
          Get Tickets
        </Link>
        <Link to="subscribe" className="side-item" variants={listVariant}>
          Subscribe Now
        </Link>
        <Link to="food" className="side-item" variants={listVariant}>
          Food and Drinks
        </Link>
        <Link to="bookings" className="side-item" variants={listVariant}>
          Bookings
        </Link>
      </motion.div>
    </article>
